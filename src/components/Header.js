      ...
      <header className={`header ${isScrolled ? 'scrolled' : ''}`}>
        <div className="header__container">
          ...
          <div className="header__actions">
            <a href="/hr-login.html" className="btn btn-primary header__cta hidden md:inline-flex" data-analytics="header-cta-hr-login">
              Launch HR Portal
            </a>
      ...
      <div id="mobile-menu" className={`mobile-menu ${isMobileMenuOpen ? 'active' : ''}`}>
        ...
        <div className="mobile-menu__content">
          ...
          <div className="mobile-menu__actions">
            <a href="/hr-login.html" className="btn btn-primary w-full mb-3" data-analytics="mobile-menu-hr-login" onClick={closeMobileMenu}>
              Launch HR Portal
            </a>
            <a href="/employee-login.html" className="btn btn-secondary w-full" data-analytics="mobile-menu-employee-login" onClick={closeMobileMenu}>
              Employee Sign In
            </a>
          </div>
        </div>
